...
BASE_DIR = Path(r"C:/Users/fraca/Documents/GitHub/crnn_lid").resolve()

TRAIN_CSV = BASE_DIR / "train_data_dir" / "training.csv"
VAL_CSV = BASE_DIR / "validation_data_dir" / "validation.csv"
TEST_CSV = BASE_DIR / "test_data_dir" / "testing.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--shape", nargs=3, type=int, default=[129, 200, 1])
    parser.add_argument("--pixel-per-second", dest="pps", type=int, default=50)
    parser.add_argument(
        "--segment-length",
        dest="segment_length",
        type=float,
